var langStr={
	HELP:'Справка',
	ACTIONS:'Режимы',
	ACT_KEYMOVE:'Перемещение кнопками клавиатуры (<span class="hotkey">k</span>)',
	ACT_GLOBALMOVE:'Глобальное перемещение',
	ACT_GLOBALSIZE:'Глобальный размер',
	ACT_YONGUP:'Более молодые номера сверху.',
	ACT_BUILDROUTE:'Построить маршрут (<span class="hotkey">r</span>)',
	ACT_TEMPGLINES:'Рисование линий (<span class="hotkey">l</span>)',
